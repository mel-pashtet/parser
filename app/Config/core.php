 ...
 */
	...
	Configure::write('sites',array(
		'Ялта Кик' => array(
			...
			'regularForTitle' => array(
				'first' => '/adsmanager_ads_title[\s\S]+<\/h2/',
				'second' => '/(^adsmanager_ads_title[\s\S]+<\/b>)/',
				'third' => '/(\<br[\s\S]+)/',
			),
			'regularForOnePageSmallerPice' => '/adsmanager_ads_main[\S\s]+<!-- maininner end -->/',
			...
			'regularForDescription' => array(
				'first' => '/adsmanager_ads_desc[\s \S]+adsmanager_ads_desc/',
	...
	Configure::write('currentSite', Configure::read('sites')['Ялта Кик']);
/**
 ...
 *
 */
	Configure::write('Routing.admin', array('admin'));
